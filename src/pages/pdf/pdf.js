...
var PdfPage = (function () {
    function PdfPage(navCtrl, sanitizer, store) {
        var _this = this;
        ...
        this.pdfUrlSubscription = store.select('selectedFormURL')
            .subscribe(function (selectedFormURL) {
            _this.pdfUrl = "https://docs.google.com/gview?embedded=true&url=https://s3-us-west-2.amazonaws.com/popsmoke/myarchive.pdf";
        });
    }
